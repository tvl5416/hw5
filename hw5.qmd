...
NNet <- nn_module(
  initialize = function(p, q1, q2, q3) {
    ...
    self$output_layer <- nn_linear(q3, 1) # Assuming a single output
  },
...
nnet_fit <- nnet_model %>% 
  ...
  fit(
    ...
    epochs = 100, # Adjust based on convergence and computational resources
    dataloader_options = list(num_workers = 0),
    verbose = FALSE # Change to TRUE to see training progress
  )
```
